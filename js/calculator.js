...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null) {
        ...
        // if operator exists, property lookup is performed for the operator in the Perform_Calculation object and the function that mathces the operator is executed
...
keys.addEventListener('click', (event) => {
    // the target variable is an object that represents the element that was lick
    const { target } = event;
